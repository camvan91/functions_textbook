...
\begin{thm}[Simplifying $\text{n}^{\text{th}}$ powers of $\text{n}^{\text{th}}$ roots and $\text{n}^{\text{th}}$ roots of $\text{n}^{\text{th}}$ powers]\label{simplifyradicals} 
...
\colorbox{ResultColor}{\bbm
\begin{thm}[Extracting $\text{n}^{\text{th}}$ Roots]
...
\begin{defn}[Congugate of a Square Root Expression]\label{squarerootconj} 
