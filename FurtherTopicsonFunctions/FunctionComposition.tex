...
\colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Function Composition]\label{functioncompprops}  
Suppose $f$, $g$, and $h$ are functions. \index{function ! composite ! properties of} \index{composite function ! properties of}
