...
\begin{thm}[Properties of Real Number Addition]
...
\colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Real Number Multiplication]
...
\colorbox{ResultColor}{\bbm
\begin{thm}[The Distributive Property and Factoring]
...
\label{propertiesofnegatives}
 ...
 \colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Negatives]
...
\colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Fractions]
...
\colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Integer Exponents]
...
\begin{defn}[Scientific Notation] \label{scientificnotation}
...
\colorbox{ResultColor}{\bbm
\begin{thm}[Properties of Radicals] 
