...
Here, since $n$ is odd,  $f(-x) = (-x)^n = -x^n = -f(x)$.  This means that whenever $(x, f(x))$ is on the graph, so is the point symmetric about the origin,  $(-x, -f(x))$. \co{(Again, see Definition \ref{symmetrydefn}.)} We generalize this property below.  Not surprisingly, we name it in honor of its odd powered heritage:
...
\includegraphics[height=2in]{./GraphsofPolynomialsGraphics/PolyEBEx1a.jpg}   \includegraphics[height=2in]{./GraphsofPolynomialsGraphics/PolyEBEx1b.jpg} 
...
\includegraphics[height=2in]{./GraphsofPolynomialsGraphics/PolyEBEx2a.jpg}  \hspace{.5in} \includegraphics[height=2in]{./GraphsofPolynomialsGraphics/PolyEBEx2b.jpg} 
...
\input{ExercisesforGraphsofPolynomials}
